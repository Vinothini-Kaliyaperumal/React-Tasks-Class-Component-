...
class SignIn extends Component<{}, SignInState> {
  state: SignInState = { name: '', password: '', agree: false };

  handleChange = (event: ChangeEvent<HTMLInputElement>): void => {
    const { name, value, type, checked } = event.target;
    this.setState({ [name]: type === 'checkbox' ? checked : value } as Pick<SignInState, keyof SignInState>);
  };
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="body2" style={{ marginBottom: '20px', color: '#6c757d', fontSize: '13px', lineHeight: '18px', marginTop: '15px', fontFamily: 'Georgia' }}>
                Sign in to manage your campaigns and streamline your email marketing with ConvertKit.
              </Typography>
            ...
            <Grid item xs={12} md={6}>
              ...
              <form onSubmit={this.handleSubmit} style={{ marginTop: '20px', fontFamily: 'Georgia' }}>
                ...
                <Button type="submit" variant="contained" fullWidth style={{ marginTop: '20px', borderRadius: '25px', backgroundColor: '#174193', fontFamily: 'Georgia' }}>
                  Get Started
                </Button>
              </form>
            </Grid>
